...
inidatpath = '/home/mab/projects/delaunay_voronoi/programs/fulloct2d/qa/';
inidatfiles = {  %'1c.txt';
                 %'2c_cosalph.txt';
                 %'2c_digest.txt';
                 %'2c_digest_touch.txt';  % not expected to work, cf. inivor.m
                 %'2c_digest_touch2.txt'; % not expected to work, cf. inivor.m
                 %'2c_eq_inv.txt';
                 %'2c_eq.txt';
                 %'2c_inv.txt';
                 %'2c.txt';
...
%inidatpath = '/home/mab/';
%inidatpath = '/media/mab_data/mab/projects/delaunay_voronoi/runs/2012-08-03---fixwertex/qa/';
%inidatfiles = { '2c_digest_touch.txt' };
...
plot_polarity    = 0;  % plot polarity vectors            1:y else no
plot_velocity    = 0;  % plot velocity vectors            1:y else no
